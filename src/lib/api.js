...
// Signal job (admin)
export const triggerSignalJob         = ()             => post("/api/signals/run-all");
export const getSignalJobStatus       = ()             => get("/api/signals/job-status");
export const forceRegenerateSignal    = (symbol)       => post("/api/ondemand/signal/force", { symbol });
export const resetSignalCache         = ()             => post("/api/ondemand/cache/reset");